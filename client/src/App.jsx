...
import { FrontOfficeLayout, BackOfficeLayout, AdminLayout, AddLayout, EditLayout, DefaultLayout, NotFoundLayout, LoadingLayout, LoginLayout } from './components/PageLayout';
        ...
        <Container fluid className='App'>
          ...
          <Routes>
            <Route path="/" element={loading ? <LoadingLayout /> : <DefaultLayout pages={pages} pagesFiltered={pagesFiltered} />} >
              ...
              <Route path="page/:filterId" element={loggedIn ? <BackOfficeLayout Pages={pages} setPages={setPages} pagesFiltered={pagesFiltered} setpagesFiltered={setpagesFiltered} dirty={dirty} setDirty={setDirty} /> : <Navigate replace to='/login' />} />
              <Route path="admin" element={loggedIn ? <AdminLayout Pages={pages} setPages={setPages} pagesFiltered={pagesFiltered} setpagesFiltered={setpagesFiltered} dirty={dirty} setDirty={setDirty} /> : <Navigate replace to='/login' />} />
