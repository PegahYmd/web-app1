...
const PageForm = (props) => {
  ...
  const [creation_date, setCreationDate] = useState(
    props.page && props.page.creation_date
      ? props.page.creation_date.format("YYYY-MM-DD")
      : ""
  );
  const [publication_date, setPublicationDate] = useState(
    props.page && props.page.publication_date
      ? props.page.publication_date.format("YYYY-MM-DD")
      : ""
  );
  ...
  let showImage =
    "<Image src='../src/images/1.jpg' className='block-image' /><Image  src='../src/images/2.jpg' className='block-image' />";
          ...
          <Row key={index} className="header-adder">
            <Col lg={10} md={3}>
              <Form.Control
                type="text"
                required={true}
                placeholder="Write down your header"
                value={singleHeader.header}
          ...
          <Row key={index} className="header-adder">
            <Col lg={10} md={3}>
              <Form.Control
                ...
                type="text"
                required={true}
                placeholder="Write down your paragraph"
